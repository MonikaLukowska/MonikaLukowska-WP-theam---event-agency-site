...
<head>
    ...
    <script src="https://kit.fontawesome.com/56d84fb067.js" crossorigin="anonymous" SameSite= "none Secure"></script>
                    ...
                    <div class="site-header__content" id="site-header__content">
                        ...
                        wp_nav_menu(array(
                            ...
                            <ul class="navigation__right">
                                ...
                                <li <?php if(get_post_type() == 'referencje' || is_page('referencje')) echo'class="current-menu-item"'?>><a href="<?php echo site_url('/referencje'); ?>">referencje</a></li>
